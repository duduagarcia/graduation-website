  ...
  <a :href="props.link" rel="noopener noreferrer" target="_blank">
    <div class="container is--full link-wrapper">
      ...
      <h2 class="link-wrapper-p is--duplicate">
        <div data-marquee-duplicate="10" data-marquee-scroll-direction-target="" data-marquee-direction="left"
          data-marquee-status="normal" data-marquee-speed="15" data-marquee-scroll-speed="10" class="marquee-advanced"
          :id="props.app">
