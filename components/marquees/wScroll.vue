...
<template>
  <section class="section-resource">
    <!-- Based on font size -->
    <div data-marquee-duplicatee="2" data-marquee-scroll-direction-targett="" data-marquee-directionn="left"
      data-marquee-statuss="normal" data-marquee-speedd="15" data-marquee-scroll-speedd="10" class="marquee-advanced">
